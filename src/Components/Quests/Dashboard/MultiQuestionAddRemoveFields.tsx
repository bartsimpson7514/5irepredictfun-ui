...
const MultiAddRemoveFields = ({ newFormValue, onAdd, onRemove }) => {
    const [formValues, setFormValues] = useState(
        newFormValue ? newFormValue.outcomes : [""]
    );
    const { t } = useTranslation();
    useEffect(() => {
        if (newFormValue) {
            setFormValues(newFormValue.outcomes);
        }
    }, [newFormValue]);
...
export default MultiAddRemoveFields;
