...
const OnyxSettingModal: FC<IOptionsLoadingModal> = ({ open, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center w-full py-2 text-sm font-medium pr-3 text-[#FFFFFFB2]">
                {t("Gasless Mode")}
                <span
            ...
            <div className="w-full py-3 text-sm font-medium flex text-[#FFFFFFB2]">
                ...
                <button
                    ...
                    className={` whitespace-nowrap  px-4 py-2 rounded-lg text-xs font-medium ${
                        transactionSpeedOption === TransactionSpeed.Standard
                            ...
                            : "border-primary-200 border text-[#FFFFFF66]"
                    }`}
                    onClick={() => {
                        dispatch(
                            updateTransactionSpeedOption(
            ...
            <div className="w-full py-4 text-sm font-medium text-[#FFFFFFB2]">
                {t("Slippage tolerance")}
            </div>
            <div className="flex flex-wrap gap-2 text-[#FFFFFF66]">
                <button
                    type="button"
                ...
                <input
                    type="number"
                    className="border border-primary-200 text-potential-text border-secondary bg-sidebar-border h-8 lg:w-20 w-10 p-2 rounded-lg text-xs font-medium"
                    placeholder="1%"
            ...
            <div className="w-full pt-4 pb-2 text-sm text-[#FFFFFFB2] font-medium flex flex-col">
                {t("Transaction deadline")}
                <span className=" text-sm font-inter font-normal text-[#71717A]">
            ...
            <div className="flex flex-col w-full text-xs font-medium justify-between">
                <div>
                    <button
                        type="button"
                        className="bg-footer-text w-full h-[42px] text-primary-white text-sm tracking-wider rounded-[12px] mt-3"
                        onClick={handleSave}
                    >
                        {t("Save")}
                    </button>
...
export default OnyxSettingModal;
