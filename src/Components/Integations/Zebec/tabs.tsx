    ...
    return (
        <div className="relative">
            <button
                ...
                className="relative items-center flex justify-between gap-2 outline-none text-[#11142D] transition-all duration-300 cursor-pointer focus:outline-none px-2 py-3 w-[140px] h-[38px] text-left bg-[#202124] sm:text-sm rounded-lg"
                ref={buttonRef}
            ...
            >
                <span className="flex items-center justify-center gap-2">
                    ...
                    >
                        <span className="text-sm text-[#FFFFFFE5] leading-4 font-medium">
                            {
                                tabs.find(
                                    tab =>
                ...
                <span className="absolute right-3 inset-y-0  flex items-center cursor-pointer">
                    <DropdownArrow className="stroke-[#FFFFFFE5]" />
                </span>
            </button>
                            ...
                            <>
                                {tab.name !== "History" && (
                                    <Link href={tab.link} key={tab.name}>
                                        ...
                                        group  relative min-w-0 overflow-hidden py-2  px-8 font-normal text-center text-sm hover:text-white focus:z-10
                                    `}
                                        >
