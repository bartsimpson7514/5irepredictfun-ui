...
import Logo from "public/svgs/Bayes-logo.svg";
import LogoName from "public/svgs/Bayes-logo-name.svg";
...
import ZebecSettingModal from "./settings-modal";

const LogoHeader = () => {
    return (
        <>
            <Logo className=" block sm:hidden h-6" />

            <LogoName className="hidden sm:block h-6 w-auto" />
        </>
    );
};

const ZebecHeader = ({ setMagicLoading }) => {
    const {
        active,
        account,
        chainId,
    ...
    return (
        <>
            ...
            <section
                style={{ borderBottom: "0.1px solid #E5E7EB33" }}
                className="relative  flex-shrink-0 shadow justify-between py-6 "
            >
                <div className="relative z-100 flex-shrink-0 flex  shadow justify-between  pl-4 sm:pl-6">
