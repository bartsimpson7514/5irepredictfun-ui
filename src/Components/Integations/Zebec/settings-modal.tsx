...
const ZebecSettingModal: FC<IOptionsLoadingModal> = ({ open, onClose }) => {
        ...
        >
            ...
            <div className="flex flex-col w-full text-xs font-medium justify-between">
                <div
                    ...
                    className="p-[1px]  bg-gradient-to-r w-full from-[#08E0A3] to-[#E0AE1F] rounded-[6px]"
                >
                    <button
                        type="button"
                        className=" sm:py-[5px] sm:relative w-full sm:px-3 px-2 py-2 hover:bg-opacity-70 rounded-md bg-[#1A1B1F] text-primary-white"
                        onClick={handleSave}
                    >
                        {t("Save")}
                    </button>
...
export default ZebecSettingModal;
