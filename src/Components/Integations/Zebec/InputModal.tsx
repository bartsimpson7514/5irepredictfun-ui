                ...
                <div className="w-full flex flex-col gap-2">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className=" bg-[#FFFFFF1A] flex-row gap-2 flex items-center justify-center cursor-pointer px-2 py-1 rounded-[8px] border-none outline-none transition-all duration-300  sm:text-sm"
                        >
                            <CurrencyIcon
                    ...
                    <div className="flex gap-5 items-center justify-end">
                        <span
                            className={`bg-[#1A1B1F] rounded-[12px] h-full text-xs  cursor-pointer  px-2 ${
                                amount === maxAmount / 4 && amount !== 0
                                    ? "text-[#FFFFFFE5] border border-[#08E0A3]"
                                    : "text-[#FFFFFF66] "
                            } `}
                            role="none"
                            onClick={on25Select}
                        ...
                        <span
                            className={`bg-[#1A1B1F] rounded-[40px] text-xs  cursor-pointer  px-2  ${
...
export default ZebecInputField;
