    ...
    return (
        <div className={`${margin ? "mt-3" : ""} relative oddz-select`}>
            <button
                ...
                className={`flex items-center border border-light border-gray-700 rounded-lg  outline-none  transition-all duration-300 px-3 py-[6px] text-left cursor-default focus:outline-none sm:text-sm ${variant}`}
                onClick={() => {
...
export default QuickSwapNetworkSelect;
