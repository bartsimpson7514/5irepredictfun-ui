...
const ZeroSwapNetworkSelect = ({
    ...
    const NetworkGradientColor = {
        ...
        "Polygon zkEVM": "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        "Mantle Testnet": "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        Mantle: "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        "opBNB Testnet":
            "linear-gradient(102.15deg,#fce09f -40%,#ffb508 113.09%)",
        "Telos EVM Mainnet":
            "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        "Rollux Mainnet": "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        Nautilus: "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
        "Manta Pacific": "linear-gradient(270deg, #7542CA 0%, #B197DD 100%)",
    };
    ...
    return (
        <div className={`${margin ? "mt-3" : ""} relative oddz-select`}>
            <button
                ...
                ref={buttonRef}
                style={{ background: NetworkGradientColor[options[value]] }}
                className="  text-[#F5F6FA] inline-flex !py-[5px] !px-[7px] lg:!px-3 min-w-32 lg:!py-2 items-center justify-center overflow-hidden rounded-full group "
            >
            ...
            {expanded ? (
                <div
                    ...
                    className="absolute z-[999] flex flex-col justify-center py-5 mt-2 text-center w-52 bg-[#ffffff] top-9 right-1 rounded-2xl"
                >
...
export default ZeroSwapNetworkSelect;
